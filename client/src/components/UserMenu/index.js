...
const AdminInfoHeader = React.lazy(() =>
            ...
            {user ? (
                <>
                    ...
                    <div className={style.dropdown}>
                        ...
                        <ul>
                            <li>
                                <Link to="/dashboard" className={style.sublink}>
                                    Dashboard
                                </Link>
                            </li>
                            <li>
                                <Link to="/profile" className={style.sublink}>
                                    Profile
                                </Link>
                            </li>
                            <li>
                                <Link to="/settings" className={style.sublink}>
                                    Settings
                                </Link>
                            </li>
                            <li>
