  ...
  return (
    <div className={style.boxBig}>
      ...
      <div className={style.content}>
        <h2 className={style.title}><Link to={`/post/${id}`}>{name}</Link></h2>
        ...
        <div className={style.footer}>
          ...
          <div className={style.info}>
            {abv && (<span className={style.infoItem}>abv - {abv}</span>)}
            {ibu && (<span className={style.infoItem}>ibu - {ibu}</span>)}
          </div>
        </div>
      </div>
    </div>
